      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        <header className="mb-10">
          ...
          <p className="text-slate-400 mt-2">
            You have {meds.length} doses scheduled for today.
          </p>
        </header>
        ...
        <div className="relative max-w-2xl mb-12 z-50" ref={dropdownRef}>
          <div className="relative group">
            ...
            <input
              ...
              placeholder="Search medications (Press Enter to see all)..."
              ...
              <div className="p-2">
                {searchResults.map((result) => (
                  <button
                    ...
                    onClick={() =>
                      router.push(
                        `/search-results?q=${encodeURIComponent(result.name)}`
                      )
                    }
                ...
                <button
                  ...
                  className="w-full p-3 text-center text-[10px] font-black text-indigo-400 hover:bg-white/5 transition-colors border-t border-white/5 tracking-widest"
                >
                  VIEW ALL RESULTS
                </button>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-full">
          ...
          >
            <div className="z-10">
              ...
              <p className="text-indigo-100 mt-4 max-w-[200px]">
                Track your doses, schedule, and stock levels.
              </p>
            </div>
